            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal " name="myform"  method="post" action="save_import.php" enctype="multipart/form-data" onsubmit="return val();">
                                  <?php  
                                   if(!empty($_GET['msg'])) { ?>
          <header class="panel-heading"><?php echo "<font color='LightSeaGreen'>".$_GET['msg']."</font>"; ?></header>                          
      <?php    echo "<script>setTimeout(\"location.href = 'import_coupon.php';\",1500);</script>";    }   ?>                                  
                                    
                                    </header>                          
                           
                                    <div class="form-group">
                                        <label for="coupon_pack" class="control-label col-lg-3">Select Package File</label>
                                        <div class="col-lg-6">
                                            <input type="file" id="coupon_pack" name="coupon_pack" />
                                        </div>
                                    </div>
