...
if(isset($_POST['submit'])){
    ...
    //fred
    $IOS_GCM_OBJ->sendNotification('c70ac07683babf1094a32adca9954ff507d9a0a00f2a8bcb57d188c027f3877a', $message1);

    //lior
    $IOS_GCM_OBJ->sendNotification('e4d35afad9feb8ad58a777fc5615383365fa004d68b17f1f36fe82888d6834cd', $message1);
    $IOS_GCM_OBJ->sendNotification('a86cfc49d7f986586d1997e343df227faf41260e712cd3fb15b6d5806afee45b', $message1);
    $IOS_GCM_OBJ->sendNotification('b6405844eb731a1bd912d73be8ed986bebb5b6a5a9b00fe241d86cc0fd220063', $message1);
    $IOS_GCM_OBJ->sendNotification('157746d14c093987087cc4ae62cf066496e3eeaf5b9671b8c8f4f781d1667f6d', $message1);
    $IOS_GCM_OBJ->sendNotification('889907f1406bebdfc1f5d1f754544032566f30f0f9ea6f01eefff00bd7707ac8', $message1);
    //Roys
    $IOS_GCM_OBJ->sendNotification('44fcdc78772f13a97bca8a731ed86c86b14874d18c5cfe0c791818a537b487f1', $message1);

    //Liat
    $IOS_GCM_OBJ->sendNotification('765d1659273af69cad2a07c3cb304fcd77a6cb1911949ebf76a331f135df17af', $message1);



    /*$sql = "Select device_gcm from coupan_gcm where device_gcm !='' AND device_type = 'ios' GROUP BY device_gcm";

    $run = mysql_query($sql) or die(mysql_error());

    $i = 0;
    $registatoin_ids[$i] = array();
    while($result = mysql_fetch_assoc($run)){
        $regId = $result['device_gcm'];

        $registatoin_ids[$i] = $regId;
        $i++;
        if($i == 50)
        {
            $IOS_GCM_OBJ->sendNotification1($registatoin_ids, $message1);
    ...
    $sql = "Select device_gcm from coupan_gcm where device_gcm !='' AND device_type = 'Android' GROUP BY device_gcm";
   ...
   while($result = mysql_fetch_assoc($run)){
       ...
       if($i == 1000)
       {
           $GCM_BOJ->send_notification($registatoin_ids, $message);
           unset($registatoin_ids);
           $registatoin_ids = array();
           $i = 0;
       }
