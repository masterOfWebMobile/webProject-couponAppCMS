            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal " name="myform"  method="post" action="save_store.php" enctype="multipart/form-data" onsubmit="return val();">
                                  <?php  
                                  if(!empty($_GET['msg'])) { ?>
                                ...
                                <?php }  ?>
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="s_name" name="s_name" type="text" value="" />
                                        </div>
                                    </div>
                                    <div class="form-group">
					    ...
					    <option value="">Select City</option>						
						  ...
						  <?php
							...
							?>
                                ...
                                <div class="col-md-4 col-xs-11">
                                     <input class=" form-control" id="s_address" name="s_address" type="text" value="" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 col-xs-11">
                                     <input class=" form-control"  id="s_lat" name="s_lat" type="text" value="" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 col-xs-11">
                                     <input class=" form-control"  id="s_long" name="s_long" type="text" value="" />
