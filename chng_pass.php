...
function val(){
	if (document.myform.cur_pass.value=="")  
	  {
	     alert("Please Enter Current Password");
	     return false;
          }
   if (document.myform.new_pass.value=="")  
	  {
	     alert("Please Enter New Password");
	     return false;
          }
     
    if (document.myform.confirm_pass.value=="")  
	  {
...
<form class="cmxform form-horizontal " name="myform"  method="post" action="save_password.php" enctype="multipart/form-data" onsubmit="return val();">
                                  <?php  
                                   if(!empty($_GET['msg'])) { ?>
          <header class="panel-heading"><?php echo "<font color='LightSeaGreen'>".$_GET['msg']."</font>"; ?></header>                          
      <?php    echo "<script>setTimeout(\"location.href = 'chng_pass.php';\",1500);</script>";    }   ?>                                  
                                    
                                    </header>                          
                           
                                    <div class="form-group ">
                                        <label for="firstname" class="control-label col-lg-3"><strong>Current Password</strong></label>
                                        <div class="col-lg-6">
                                           <input type="password" class=" form-control" name="cur_pass" id="cur_pass" value="">		
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="firstname" class="control-label col-lg-3"><strong>New Password</strong></label>
                                        <div class="col-lg-6">
                                           	<input type="password" class=" form-control" name="new_pass" id="new_pass" value="">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="firstname" class="control-label col-lg-3"><strong>Confirm Password</strong></label>
                                        <div class="col-lg-6">
