...
<!--sidebar end-->
    ...
    <section id="main-content">
      ...
      <?php    echo "<script>setTimeout(\"location.href = 'view_store.php';\",1500);</script>";    }   ?>
                    <div class="panel-body">
                        <div class="adv-table editable-table ">
                            <div class="clearfix">
                                <div class="btn-group">
                                    <!--button id="editable-sample_new" class="btn btn-primary"></button-->
                                       <a href="add_store.php" class="btn btn-primary" > Add New Store<i class="fa fa-plus"></i></a>
                     ...
                     <input type="hidden" name="message" id="message" value="<?php echo $_GET['msg']; ?>">                            
                            ...
                            <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                ...
                                <tr class="">
                                    ...
                                    <td><img src="<?php  echo $data['s_image']; ?>" alt="" width="80" height="60" ></td>
                                    <td><?php  echo $data['s_address']; ?></td>
                                    <td><?php  echo $data['s_text']; ?></td>
                                   
                                    <td><a href="edit_store.php?id=<?php echo $data['id']; ?>">Edit</a></td>
                                    <td><a href="store_del.php?id=<?php echo $data['id']; ?>" onclick="return confirm('Are you sure you want to delete record?');">Delete</a></td>                                    
