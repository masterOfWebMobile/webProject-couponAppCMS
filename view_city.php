...
<!--sidebar end-->
    ...
    <section id="main-content">
      ...
      <?php    echo "<script>setTimeout(\"location.href = 'view_city.php';\",1500);</script>";    }   ?>
                     ...
                     <input type="hidden" name="message" id="message" value="<?php echo $_GET['msg']; ?>">                            
                            ...
                            <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                ...
                                <tr class="">
                                    ...
                                    <td><?php  echo $data['c_lat']; ?></td>
                                    <td><?php  echo $data['c_long']; ?></td>
                                   
                                    <td><a href="edit_city.php?id=<?php echo $data['id']; ?>">Edit</a></td>
                                    <td><a href="city_del.php?id=<?php echo $data['id']; ?>" onclick="return confirm('Are you sure you want to delete record?');">Delete</a></td>                                    
