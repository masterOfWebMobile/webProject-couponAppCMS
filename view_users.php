...
<!--sidebar end-->
    ...
    <section id="main-content">
      ...
      <?php    echo "<script>setTimeout(\"location.href = 'view_users.php';\",1500);</script>";    }   ?>
                    <div class="panel-body">
                        <div class="adv-table editable-table ">
                            <div class="clearfix">
                                <div class="btn-group">
                                    <!--button id="editable-sample_new" class="btn btn-primary"></button-->
                                       <a href="add_user.php" class="btn btn-primary" > Add New <i class="fa fa-plus"></i></a>
                     ...
                     <input type="hidden" name="message" id="message" value="<?php echo $_GET['msg']; ?>">                            
                            ...
                            <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                ...
                                <tr class="">
                                    ...
                                    <td><a href="edit_users.php?id=<?php echo $data['id']; ?>">Edit</a></td>
                                    <td><a href="user_del.php?id=<?php echo $data['id']; ?>" onclick="return confirm('Are you sure you want to delete record?');">Delete</a></td>                                    
