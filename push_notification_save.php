...
if(isset($_POST['submit'])){
	...
	$sql = "UPDATE `shabbat_msg` SET `msg` = '$message1' WHERE `msg_id` = 1;" ;
	$run = mysql_query($sql) or die(mysql_error());
	
}

$query_msg = "SELECT * FROM `shabbat_msg` WHERE msg_id = '1'";
$result_msg = mysql_query($query_msg);
$fetch_msg = mysql_fetch_array($result_msg);
$message_save = $fetch_msg['msg'];
                            ...
                            <div class="form">
                                ...
                                <?php }  ?>
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea id="notify" name="notify"><?php echo $message_save; ?></textarea>
                                        </div>
                                    </div>
