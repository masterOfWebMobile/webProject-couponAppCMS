...
function val(){
   ...
   if (document.myform.m_title.value=="")  
	  {
	     alert("Please Insert Medicine Title");
	     return false;
          }
     
    if (document.myform.m_detail.value=="")  
	  {
	     alert("Please Insert Medicine Detail");
	     return false;
          }       
    if (document.myform.description.value=="")  
	    {
	     alert("Please Insert Medicine Description");
	     return false;
          }  
                ...
                <div class="col-lg-12">
                    <section class="panel">
                       ...
                       if(!empty($_GET['id'])) {                        
                        ...
                        $chk = "select * from add_policy where id ='".$_GET['id']."'";
  	                      $fire = mysql_query($chk) or die(mysql_error());
  	                       $data = mysql_fetch_assoc($fire);
  	                       ?>
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal " name="myform"  method="post" action="save_edit_policy.php" enctype="multipart/form-data" onsubmit="return val();">
                                  <?php  
                                  if(!empty($_GET['msg'])) { ?>
                                    <header class="panel-heading"><?php echo $_GET['msg']; ?></header>                          
                                <?php }  ?>
                                         <div class="form-group ">
                                        <label for="firstname" class="control-label col-lg-3">Policy Name</label>
                                        <div class="col-lg-6">
                                            <textarea class=" form-control" id="p_name" name="p_name" ><?php echo $data['p_name']; ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group ">
                                     ...
                                     <input type="hidden" name="p_id" id="p_id" value="<?php echo $data['id']; ?>" />
