    ...
    <script type="text/javascript" >
        function val() {
            ...
            if (document.myform.img_upload.value == "") {
                ...
                alert("Please select only jpg and png file.");
                return false;
            }
    ...
    <section class="wrapper">
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                ?>
                <img src="<?php echo $banner; ?>"  width="90%"/>
            </div>
            <div class="col-sm-6">

                <form class="cmxform form-horizontal " name="myform"  method="post" action="update_banner.php" enctype="multipart/form-data" onsubmit="return val();">
                    <div class="form-group ">
                        <label  for="exampleInputFile" class="control-label col-lg-3">Select New Banner Image</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        <div class="col-lg-offset-3 col-lg-6">
                            ...
                            <a class="btn btn-success" href="dashboard.php">Refresh</a>
                            <a class="btn btn-danger" href="update_banner.php?action=delete">Delete</a>
                        </div>
