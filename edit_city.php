...
function val(){
   ...
   if (document.myform.c_lat.value=="")  
	  {
	     alert("Please Insert City Latitude");
	     return false;
          }
       if (document.myform.c_long.value=="")  
	  {
	     alert("Please Insert City Longitude");
	     return false;
          } 
...
<script src="https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=places"></script>
  ...
  function initialize() {
        var address = (document.getElementById('c_name'));
        ...
        document.getElementById('c_long').value = place.geometry.location.lng();
        });
  }
                ...
                <div class="col-lg-12">
                    <section class="panel">
                       ...
                       if(!empty($_GET['id'])) {                        
                        ...
                        $chk = "select * from add_city where id ='".$_GET['id']."'";
  	                      $fire = mysql_query($chk) or die(mysql_error());
  	                       $data = mysql_fetch_assoc($fire);
  	                       ?>
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal " name="myform"  method="post" action="save_edit_city.php" enctype="multipart/form-data" onsubmit="return val();">
                                  <?php  
                                  if(!empty($_GET['msg'])) { ?>
                                ...
                                <?php }  ?>
                                   ...
                                   <div class="form-group">
                                <label for="firstname" class="control-label col-lg-3">City Latitude</label>
                                <div class="col-md-4 col-xs-11">
                                     <input class=" form-control" id="c_lat" name="c_lat" readonly="Readonly" type="text" value="<?php echo $data['c_lat']; ?>" />
                                   
                                </div>
                            </div>     
                                    <div class="form-group ">
                                        <label  for="exampleInputFile" class="control-label col-lg-3">City Longitude</label>
                                        <div class="col-lg-6">
                                            <input class="form-control" id="c_long" name="c_long" readonly="Readonly" type="text" value="<?php echo $data['c_long']; ?>" />
                                        </div>
                                    </div>
                                    <!--div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                     ...
                                     <input type="hidden" name="ct_id" id="ct_id" value="<?php echo $data['id']; ?>" />
