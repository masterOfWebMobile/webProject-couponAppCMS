...
function val(){
	...
	if (document.myform.p_name.value=="")  
	  {
	     alert("Please Insert Policy Name");
	     return false;
          }
            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal " name="myform"  method="post" action="save_policy.php" enctype="multipart/form-data" onsubmit="return val();">
                                  <?php  
                                   if(!empty($_GET['msg'])) { ?>
          <header class="panel-heading"><?php echo "<font color='LightSeaGreen'>".$_GET['msg']."</font>"; ?></header>                          
      <?php    echo "<script>setTimeout(\"location.href = 'add_policy.php';\",1500);</script>";    }   ?>                                  
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea class=" form-control" id="p_name" name="p_name" ></textarea>
                                        </div>
                                    </div>
                       ...
                       <div class="panel-body">
                            ...
                            <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                ...
                                <tbody>
                                <?php while($data = mysql_fetch_assoc($run)) {  ?>
                                <tr class="">
                                    <td><?php echo $data['p_name'];  ?></td>
                                   
                                   
                                    <td><a href="edit_policy.php?id=<?php echo $data['id']; ?>">Edit</a></td>
