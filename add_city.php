            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal " name="myform"  method="post" action="save_city.php" enctype="multipart/form-data" onsubmit="return val();">
                                  <?php  
                                  if(!empty($_GET['msg'])) { ?>
                                ...
                                <?php }  ?>
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="c_name" name="c_name" type="text" placeholder="Enter a Location" value="" />
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label  for="exampleInputFile" class="control-label col-lg-3"><b>Enter Location :</b></label>
                                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 col-xs-11">
                                     <input class=" form-control" id="c_lat" readonly="Readonly" name="c_lat" type="text" value="" />
                                   
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="firstname" class="control-label col-lg-3">City Longitude :</label>
                                <div class="col-md-4 col-xs-11">
                                     <input class=" form-control" id="c_long" readonly="Readonly" name="c_long" type="text" value="" />
